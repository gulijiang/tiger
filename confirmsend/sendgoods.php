...
require_once("../lib/database/DBconn.php");
...
//if($response!=""){
	$mysql = new MySQL();
	$update = "update tb_order t set t.sendState = 1 where t.orderNo = '$orderId' ";
	if($mysql->update($update)){
		header("Location:http://www.teesays.com/manage/order.php");
	}
//}
